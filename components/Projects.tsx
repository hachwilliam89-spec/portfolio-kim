...
const projects: Project[] = [
    {
        ...
        screenshots: [
            ...
            { url: '/images/kcd-v2-lobby.jpg', title: 'Lobby multijoueur', description: 'Lobby du mode duel 1 contre 1 : créer un salon (code à partager) ou rejoindre par code, avec le statut « prêt » de chaque joueur.', titleEn: 'Multiplayer lobby', descriptionEn: '1v1 duel lobby: create a room (shareable code) or join by code, with each player\'s "ready" status.' },
            { url: '/images/kcd-v2-duel.jpg', title: 'Duel en temps réel', description: 'Partie versus 1 contre 1 : chacun défend son château et dépense son or pour envoyer des ennemis chez l\'adversaire, ce qui augmente son revenu.', titleEn: 'Real-time duel', descriptionEn: '1v1 versus game: each player defends their castle and spends gold to send enemies to the opponent, which increases their income.' },
